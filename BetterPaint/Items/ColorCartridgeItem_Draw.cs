...
namespace BetterPaint.Items {
	partial class ColorCartridgeItem : ModItem {
		...
		public override void PostDrawInInventory( SpriteBatch sb, Vector2 pos, Rectangle frame, Color drawDolor, Color itemColor,
		...
		public override void PostDrawInWorld( SpriteBatch sb, Color lightColor, Color alphaColor, float rotation, float scale,
			...
			Texture2D overlayTex = ColorCartridgeItem.ColorOverlayTex;

			sb.Draw( overlayTex, pos, lightColor.MultiplyRGBA( this.MyColor ) );
		}
	}
}
